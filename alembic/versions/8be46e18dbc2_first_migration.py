...
Revision ID: 8be46e18dbc2
Revises: 
Create Date: 2024-12-27 20:52:01.358324
...
def upgrade():
    ...
    sa.CheckConstraint('invested_amount >= 0 AND invested_amount <= full_amount', name='check_invested_amount_validity'),
